...
namespace Verbum.WebApi.Migrations
{
    ...
    [Migration("20230109160755_addNewFildsInGroupMessageComments")]
    partial class addNewFildsInGroupMessageComments
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Verbum.Domain.Users.ContactGroup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ed0a9c1b-349f-47c8-8eff-17b5c41e3c68"),
                            GroupName = "General"
                        });
                });
