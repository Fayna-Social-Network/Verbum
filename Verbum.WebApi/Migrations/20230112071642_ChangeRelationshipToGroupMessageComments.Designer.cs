...
namespace Verbum.WebApi.Migrations
{
    ...
    [Migration("20230112071642_ChangeRelationshipToGroupMessageComments")]
    partial class ChangeRelationshipToGroupMessageComments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Verbum.Domain.Users.ContactGroup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5db7e878-ca4d-4ce1-8400-09f7fc7d6b37"),
                            GroupName = "General"
                        });
                });
            ...
            modelBuilder.Entity("Verbum.Domain.Groups.GroupsMessages.GroupMessageComment", b =>
                {
                    b.HasOne("Verbum.Domain.Groups.GroupsMessages.GroupMessageComment", null)
