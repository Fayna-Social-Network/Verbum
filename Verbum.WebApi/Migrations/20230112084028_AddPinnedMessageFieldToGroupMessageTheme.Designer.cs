...
namespace Verbum.WebApi.Migrations
{
    ...
    [Migration("20230112084028_AddPinnedMessageFieldToGroupMessageTheme")]
    partial class AddPinnedMessageFieldToGroupMessageTheme
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Verbum.Domain.Users.ContactGroup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9de318b7-de37-452f-80ac-ff107687a0a3"),
                            GroupName = "General"
                        });
                });
